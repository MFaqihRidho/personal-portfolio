        ...
        <div>
            ...
            >
                <path
                    fill="#FCA311"
                    fill-opacity="1"
                    d="M0,128L80,149.3C160,171,320,213,480,224C640,235,800,213,960,202.7C1120,192,1280,192,1360,192L1440,192L1440,320L1360,320C1280,320,1120,320,960,320C800,320,640,320,480,320C320,320,160,320,80,320L0,320Z"
                ></path>
            </svg>
                        ...
                        <div className="flex flex-col gap-3 text-center">
                            <Border
                                children={
                                    ...
                                    >
                                        <img
                                            className="xl:h-80 lg:h-64 h-28 md:h-44 w-full md:w-90 object-cover"
            ...
            >
                <path
                    fill="#FCA311"
                    fill-opacity="1"
                    d="M0,96L120,90.7C240,85,480,75,720,90.7C960,107,1200,149,1320,170.7L1440,192L1440,0L1320,0C1200,0,960,0,720,0C480,0,240,0,120,0L0,0Z"
                ></path>
            </svg>
        </div>
    );
